/*! @sentry/browser 4.2.3 (e3d42275) | https://github.com/getsentry/sentry-javascript */
    ...
    ***************************************************************************** */
    ...
    var API = /** @class */ (function () {
        ...
        API.prototype.getRequestHeaders = function (clientName, clientVersion) {
            ...
            if (dsn$$1.pass) {
                header.push("sentry_secret=" + dsn$$1.pass);
            }
            return {
    ...
    var BaseClient = /** @class */ (function () {
        ...
        BaseClient.prototype.prepareEvent = function (event, scope, hint) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, environment, _b, maxBreadcrumbs, release, dist$$1, prepared, exception, request;
                return __generator(this, function (_c) {
                    _a = this.getOptions(), environment = _a.environment, _b = _a.maxBreadcrumbs, maxBreadcrumbs = _b === void 0 ? DEFAULT_BREADCRUMBS : _b, release = _a.release, dist$$1 = _a.dist;
         ...
         * @inheritDoc
         */
        BaseClient.prototype.getIntegration = function (integration$$1) {
            try {
                return this.integrations[integration$$1.id] || null;
            }
            catch (_oO) {
                logger_1.logger.warn("Cannot retrieve integration " + integration$$1.id + " from the current Client");
                return null;
            }
        };
        return BaseClient;
    ...
    var Dedupe = /** @class */ (function () {
        ...
        Dedupe.prototype.setupOnce = function () {
            var _this = this;
            dist$1.addGlobalEventProcessor(function (currentEvent) { return __awaiter(_this, void 0, void 0, function () {
                var self;
                return __generator(this, function (_a) {
    ...
    var InboundFilters = /** @class */ (function () {
        ...
        InboundFilters.prototype.setupOnce = function () {
            var _this = this;
            dist$1.addGlobalEventProcessor(function (event) { return __awaiter(_this, void 0, void 0, function () {
                var self;
                return __generator(this, function (_a) {
                    self = dist$1.getCurrentHub().getIntegration(InboundFilters);
                    if (self) {
    ...
    var Debug = /** @class */ (function () {
        ...
        Debug.prototype.setupOnce = function () {
            var _this = this;
            dist$1.addGlobalEventProcessor(function (event, hint) { return __awaiter(_this, void 0, void 0, function () {
                var self;
                return __generator(this, function (_a) {
    ...
    var integrations_6 = integrations.RewriteFrames;
    ...
    */
    ...
    function wrap(fn, options, before) {
        ...
        var wrapped = function () {
            ...
            try {
                ...
                ignoreNextOnError();
                dist_6$2(function (scope) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
    ...
    var GlobalHandlers = /** @class */ (function () {
        ...
        GlobalHandlers.prototype.setupOnce = function () {
            subscribe(function (stack, _, error) {
                ...
                var self = dist_8().getIntegration(GlobalHandlers);
                if (self) {
                    dist_8().captureEvent(self.eventFromGlobalHandler(stack), { originalException: error, data: { stack: stack } });
                }
            });
    ...
    var Breadcrumbs = /** @class */ (function () {
        ...
        Breadcrumbs.prototype.instrumentBeacon = function () {
            ...
            function beaconReplacementFunction(originalBeaconFunction) {
                return function () {
                    ...
                    var client = dist_8().getClient();
                    var dsn = client && client.getDsn();
                    if (dsn) {
                        var filterUrl = new dist_12(dsn).getStoreEndpoint();
        ...
        Breadcrumbs.addBreadcrumb = function (breadcrumb, hint) {
            if (dist_8().getIntegration(Breadcrumbs)) {
                dist_8().addBreadcrumb(breadcrumb, hint);
            }
        };
        /**
    ...
    var LinkedErrors = /** @class */ (function () {
        ...
        LinkedErrors.prototype.setupOnce = function () {
            var _this = this;
            dist_7$2(function (event, hint) { return __awaiter(_this, void 0, void 0, function () {
                var self;
                return __generator(this, function (_a) {
                    self = dist_8().getIntegration(LinkedErrors);
                    if (self) {
    ...
    var ReportingObserver = /** @class */ (function () {
        ...
        ReportingObserver.prototype.handler = function (reports) {
            var e_1, _a;
            if (!dist_8().getIntegration(ReportingObserver)) {
                return;
            }
            var _loop_1 = function (report) {
                dist_6$2(function (scope) {
    ...
    var UserAgent = /** @class */ (function () {
        ...
        UserAgent.prototype.setupOnce = function () {
            var _this = this;
            dist_7$2(function (event) { return __awaiter(_this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    if (dist_8().getIntegration(UserAgent)) {
    ...
    var Ember = /** @class */ (function () {
        ...
        Ember.prototype.setupOnce = function () {
            ...
            this.Ember.onerror = function (error) {
                if (dist_8().getIntegration(Ember)) {
                    dist_6$2(function (scope) {
            ...
            this.Ember.RSVP.on('error', function (reason) {
                if (dist_8().getIntegration(Ember)) {
                    ...
                    if (reason instanceof Error) {
                        ...
                        _this.addIntegrationToSdkInfo(scope);
                        dist_4$2('Unhandled Promise error detected');
                    }
                    dist_8().popScope();
                }
            });
    ...
    exports.addBreadcrumb = dist_1$3;
    exports.captureException = dist_2$3;
    exports.captureEvent = dist_3$2;
    exports.captureMessage = dist_4$2;
    exports.configureScope = dist_5$2;
    exports.withScope = dist_6$2;
